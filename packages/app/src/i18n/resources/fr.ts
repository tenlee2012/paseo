  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "Supprimer",
        recommendation:
          "Taille recommandée : ordinateur 2560 × 1440 (16:9) ; téléphone 1440 × 2560 (9:16). Utilisez JPG ou PNG",
        opacity: "Opacité",
        opacityHint: "Contrôle l'intensité de l'image à travers l'application",
        opacityAccessibility: "Opacité de l'image d'arrière-plan",
        imagePickerTitle: "Choisir une image d'arrière-plan",
        imagePickerFilter: "Images d'arrière-plan",
        errorTitle: "Impossible de mettre à jour l'image d'arrière-plan",
        saveFailed: "Impossible d'enregistrer l'image d'arrière-plan",
        removeFailed: "Impossible de supprimer l'image d'arrière-plan",
        removeTitle: "Supprimer l'image d'arrière-plan",
        removeMessage: "Cette action supprime l'image enregistrée de cet appareil",
      },
    },
    shortcuts: {
