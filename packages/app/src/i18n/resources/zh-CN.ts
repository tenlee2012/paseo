  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "移除",
        recommendation:
          "建议尺寸：桌面端 2560 × 1440（16:9）；手机端 1440 × 2560（9:16）。使用 JPG 或 PNG",
        opacity: "透明度",
        opacityHint: "控制背景图在应用中的显示强度",
        opacityAccessibility: "背景图透明度",
        imagePickerTitle: "选择背景图",
        imagePickerFilter: "背景图",
        errorTitle: "无法更新背景图",
        saveFailed: "背景图无法保存",
        removeFailed: "背景图无法移除",
        removeTitle: "移除背景图",
        removeMessage: "这会从此设备移除已保存的图片",
      },
    },
    shortcuts: {
      dialogTitle: "快捷键",
