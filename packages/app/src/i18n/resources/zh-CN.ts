  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "背景",
        emptyTitle: "未设置背景图",
        emptyHint: "导入图片，显示在桌面端工作区背后",
        activeHint: "图片将显示在桌面端工作区背后",
        import: "导入图片",
        importing: "正在导入...",
        replace: "替换",
        remove: "移除",
        opacity: "图片透明度",
        opacityHint: "控制背景图在工作区中的显示强度",
        opacityAccessibility: "背景图片透明度",
        importFailedTitle: "无法导入背景图",
        importFailed: "所选文件不是受支持的图片。",
        removeFailedTitle: "无法移除背景图",
        removeFailed: "无法移除背景图设置。",
      },
      detailLevel: {
        title: "详细程度",
      },
