  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "إزالة",
        recommendation:
          "المقاس المقترح: سطح المكتب 2560 × 1440 ‏(16:9)؛ الهاتف 1440 × 2560 ‏(9:16). استخدم JPG أو PNG",
        opacity: "الشفافية",
        opacityHint: "يتحكم في مدى ظهور الصورة عبر التطبيق",
        opacityAccessibility: "شفافية صورة الخلفية",
        imagePickerTitle: "اختيار صورة خلفية",
        imagePickerFilter: "صور الخلفية",
        errorTitle: "تعذر تحديث صورة الخلفية",
        saveFailed: "تعذر حفظ صورة الخلفية",
        removeFailed: "تعذر إزالة صورة الخلفية",
        removeTitle: "إزالة صورة الخلفية",
        removeMessage: "سيؤدي هذا إلى إزالة الصورة المحفوظة من هذا الجهاز",
      },
    },
    shortcuts: {
