  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "削除",
        recommendation:
          "推奨サイズ：デスクトップ 2560 × 1440（16:9）、スマートフォン 1440 × 2560（9:16）。JPG または PNG を使用してください",
        opacity: "不透明度",
        opacityHint: "アプリ上での画像の見え方を調整します",
        opacityAccessibility: "背景画像の不透明度",
        imagePickerTitle: "背景画像を選択",
        imagePickerFilter: "背景画像",
        errorTitle: "背景画像を更新できません",
        saveFailed: "背景画像を保存できませんでした",
        removeFailed: "背景画像を削除できませんでした",
        removeTitle: "背景画像を削除",
        removeMessage: "このデバイスから保存済みの画像を削除します",
      },
    },
    shortcuts: {
      dialogTitle: "ショートカット",
