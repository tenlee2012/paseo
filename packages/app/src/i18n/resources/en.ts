  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        opacity: "Opacity",
        opacityHint: "Controls how strongly the image shows through the app",
        opacityAccessibility: "Background image opacity",
        imagePickerTitle: "Choose background image",
        imagePickerFilter: "Background images",
        errorTitle: "Unable to update background image",
        ...
        removeMessage: "This removes the saved image from this device",
      },
    },
    shortcuts: {
