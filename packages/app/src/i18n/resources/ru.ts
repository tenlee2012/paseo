  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "Удалить",
        recommendation:
          "Рекомендуемый размер: компьютер 2560 × 1440 (16:9); телефон 1440 × 2560 (9:16). Используйте JPG или PNG",
        opacity: "Прозрачность",
        opacityHint: "Управляет тем, насколько изображение видно через приложение",
        opacityAccessibility: "Прозрачность фонового изображения",
        imagePickerTitle: "Выбрать фоновое изображение",
        imagePickerFilter: "Фоновые изображения",
        errorTitle: "Не удалось обновить фоновое изображение",
        saveFailed: "Не удалось сохранить фоновое изображение",
        removeFailed: "Не удалось удалить фоновое изображение",
        removeTitle: "Удалить фоновое изображение",
        removeMessage: "Это удалит сохраненное изображение с этого устройства",
      },
    },
    shortcuts: {
      dialogTitle: "Ярлыки",
