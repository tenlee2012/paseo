...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "Background",
        emptyTitle: "No background image",
        emptyHint: "Import an image to display behind the desktop workspace",
        activeHint: "Displayed behind the desktop workspace",
        import: "Import image",
        importing: "Importing...",
        replace: "Replace",
        remove: "Remove",
        opacity: "Image opacity",
        opacityHint: "Controls how strongly the image shows through the workspace",
        opacityAccessibility: "Background image opacity",
        importFailedTitle: "Unable to import background image",
        importFailed: "The selected file is not a supported image.",
        removeFailedTitle: "Unable to remove background image",
        removeFailed: "The background image setting could not be removed.",
      },
      detailLevel: {
