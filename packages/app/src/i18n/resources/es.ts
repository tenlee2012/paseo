  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "Eliminar",
        recommendation:
          "Tamaño recomendado: escritorio 2560 × 1440 (16:9); móvil 1440 × 2560 (9:16). Use JPG o PNG",
        opacity: "Opacidad",
        opacityHint: "Controla cuánto se ve la imagen a través de la aplicación",
        opacityAccessibility: "Opacidad de la imagen de fondo",
        imagePickerTitle: "Elegir imagen de fondo",
        imagePickerFilter: "Imágenes de fondo",
        errorTitle: "No se pudo actualizar la imagen de fondo",
        saveFailed: "No se pudo guardar la imagen de fondo",
        removeFailed: "No se pudo eliminar la imagen de fondo",
        removeTitle: "Eliminar imagen de fondo",
        removeMessage: "Esto elimina la imagen guardada de este dispositivo",
      },
    },
    shortcuts: {
      dialogTitle: "Atajos",
