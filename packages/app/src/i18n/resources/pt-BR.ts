  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        remove: "Remover",
        recommendation:
          "Tamanho recomendado: desktop 2560 × 1440 (16:9); celular 1440 × 2560 (9:16). Use JPG ou PNG",
        opacity: "Opacidade",
        opacityHint: "Controla quanto da imagem aparece através do app",
        opacityAccessibility: "Opacidade da imagem de fundo",
        imagePickerTitle: "Escolher imagem de fundo",
        imagePickerFilter: "Imagens de fundo",
        errorTitle: "Não foi possível atualizar a imagem de fundo",
        saveFailed: "Não foi possível salvar a imagem de fundo",
        removeFailed: "Não foi possível remover a imagem de fundo",
        removeTitle: "Remover imagem de fundo",
        removeMessage: "Isso remove a imagem salva deste dispositivo",
      },
    },
    shortcuts: {
      dialogTitle: "Atalhos",
